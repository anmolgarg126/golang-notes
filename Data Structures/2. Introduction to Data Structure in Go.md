...
This is due to varing speed of the cache at diffirent level. If you go through the [below videos on cache](#cpu-caches), it shows animation for the same.

>Level one, super fast, level two, a little slower, level three, still pretty slow, but we got it done, and then level four, main memory, very very slow.
